...
export default async function PayPage({
    ...
    return (
      <div className="mx-auto max-w-md px-6 py-20 text-center">
        ...
        <p className="mt-2 text-sm text-ink-muted">
          If that was a mistake, you can book again from the braider&rsquo;s page.
        </p>
  ...
  if (!secret?.clientSecret) {
    return (
      <div className="mx-auto max-w-md px-6 py-20 text-center">
        <h1 className="font-display text-3xl text-ink">We can&rsquo;t load this payment</h1>
        <p className="mt-2 text-sm text-ink-muted">
          Try again in a moment. If it keeps happening, book again from the braider&rsquo;s page.
        </p>
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          <Link href={braiderHref}>
            <Button variant="ghost">Back to braider</Button>
          </Link>
        </div>
      </div>
    );
