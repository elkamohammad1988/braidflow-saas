...
export function LegalShell({
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16 sm:py-20">
      ...
      <div className="mt-10 space-y-9 text-[15px] leading-relaxed text-ink-muted [&_a]:font-medium [&_a]:text-ink [&_a]:underline [&_a]:underline-offset-4 [&_li]:ms-1 [&_ul]:list-disc [&_ul]:space-y-1.5 [&_ul]:ps-5">
        {children}
      </div>
    </div>
  );
